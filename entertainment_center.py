...
forrest_gump_movie = media.Movie(
	...
	"http://www.impawards.com/1994/posters/forrest_gump_xlg.jpg",  # noqa
	"https://www.youtube.com/watch?v=bLvqoHBptjg")

walle_movie = media.Movie(
	"Wall-E",
	"A robot couple brings humanity back to Earth",
	"https://img.yescdn.ru/2015/09/15/poster/WALL-E_1.jpg",  # noqa
...
potc_movie = media.Movie(
	"Pirates of the Caribbean: The Curse of the Black Pearl",
	"A pirate and his crew set sail for the cursed treasure of the Caribbean",
	"http://mrhipster.com/wp/wp-content/uploads/2015/02/pirates-of-the-caribbean-curse-of-the-black-pearl.jpg",  # noqa
